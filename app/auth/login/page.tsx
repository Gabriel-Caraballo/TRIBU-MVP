    ...
    <AuthCard title="Iniciar sesión">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="text-right">
          <Link href="/auth/forgot-password" className="text-sm text-[--tribu-blue] hover:underline">
      ...
      <div className="mt-6 text-center">
        <p className="text-sm text-[--tribu-gray]">
          ¿No tienes cuenta?{' '}
          <Link href="/auth/register" className="text-[--tribu-blue] hover:underline font-medium">
            Regístrate aquí
          </Link>
        </p>
      </div>
